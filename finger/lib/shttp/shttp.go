...
func GetFavicon(url urlparse.URL) (*http.Response, error) {
	url.Path = url.Path + "/favicon.ico"
	return GetByHash(url.UnParse())
}
...
func Get(Url string) (*http.Response, error) {
	...
	request.Header.Add("Cookie", "rememberMe=b63345edcb2b3c5084c02bd9690b6625")
	request.Close = true
...
//中文编码导致Hash指纹出错重写了一个GET请求
func GetByHash(Url string) (*http.Response, error) {
	request, err := http.NewRequest("GET", Url, nil)
	if err != nil {
		return nil, err
	}
